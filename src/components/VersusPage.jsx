              ...
              <div className={`${t.surface} rounded-2xl overflow-hidden`}>
                ...
                {dateStats1 && dateStats2 && (() => {
                  const rows = [
                    ...
                    { label: 'KO infligés / combat', v1: dateStats1.koInflByBattle, v2: dateStats2.koInflByBattle, cmp: 'max', fmt: (v) => v == null ? '—' : v.toFixed(1).replace('.', ',') },
                    { label: 'KO reçus / combat',    v1: dateStats1.koRecuByBattle,  v2: dateStats2.koRecuByBattle,  cmp: 'min', fmt: (v) => v == null ? '—' : v.toFixed(1).replace('.', ',') },
              ...
              <section>
                <div className={`${t.surface} rounded-2xl overflow-hidden`}>
                  ...
                  {[
                    ...
                    { label: 'KO infligés / combat', v1: stats1.koInflByBattle, v2: stats2.koInflByBattle, cmp: 'max', fmt: (v) => v == null ? '—' : v.toFixed(1).replace('.', ',') },
                    { label: 'KO reçus',            v1: stats1.koRecus,     v2: stats2.koRecus,     cmp: 'min', fmt: (v) => v },
                    { label: 'KO reçus / combat',   v1: stats1.koRecuByBattle,  v2: stats2.koRecuByBattle,  cmp: 'min', fmt: (v) => v == null ? '—' : v.toFixed(1).replace('.', ',') },
