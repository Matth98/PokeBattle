  ...
  return (
    ...
    <div className="relative min-h-screen">
      <div
        ...
        style={{
          background: isDark
            ? 'radial-gradient(130% 100% at 0% 0%, rgba(72,0,255,0.06) 0%, rgba(72,0,255,0) 100%), radial-gradient(ellipse 120% 70% at 100% 0%, rgba(125,252,116,0.05) 0%, rgba(125,252,116,0) 100%), #09090b'
          ...
          <div className="flex items-center gap-2">
            {inSelection ? (
              <>
                {myTeams.length > 0 && (
                  <button
                    onClick={() => setSelectedItems(myTeams.map((team) => team._id))}
