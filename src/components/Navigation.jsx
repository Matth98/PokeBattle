  ...
  return (
    ...
    >
      <div className="grid grid-cols-5 items-end px-3 pt-2 pb-2">
        ...
        >
          <span className="w-[60px] h-[60px] rounded-full outline outline-[3px] outline-white/90 outline-offset-[3px] flex items-center justify-center active:scale-95 transition">
            <img
