...
const en = {
  ...
  teams: {
    ...
    nonePlayerDescOther: (name) => `${name}'s strategy is still a mystery.`,
  ...
  pokemon: {
    ...
    nonePlayerDescOther: 'Professor Oak is still waiting for the first report.',
  },
  settings: {
...
const es = {
  ...
  teams: {
    ...
    nonePlayerDescOther: (name) => `La estrategia de ${name} sigue siendo un misterio.`,
  ...
  pokemon: {
    ...
    nonePlayerDescOther: 'El Profesor Oak todavía espera su primer informe.',
  },
  settings: {
...
const de = {
  ...
  teams: {
    ...
    nonePlayerDescOther: (name) => `${name}s Strategie ist noch ein Rätsel.`,
  ...
  pokemon: {
    ...
    nonePlayerDescOther: 'Professor Eich wartet noch auf den ersten Bericht.',
  },
  settings: {
...
const ja = {
  ...
  teams: {
    ...
    nonePlayerDescOther: (name) => `${name}の戦略はまだ謎のままです。`,
  ...
  pokemon: {
    ...
    nonePlayerDescOther: 'オーキド博士はまだ最初のレポートを待っています。',
  },
  settings: {
