      ...
      {prevTab && SUB_PAGES.includes(currentTab) && (
        ...
        >
          ...
          <Suspense fallback={null}>
            ...
            {prevTab === 'battleDetail' && selectedBattle && <BattleDetail battle={selectedBattle} players={sortedPlayers} teams={sortedTeams} t={t} isDark={isDark} backLabel={backLabel} onBack={() => {}} onEdit={() => {}} onDelete={() => {}} onAddTeam={() => {}} onCompare={() => {}} initialScrollY={scrollMemoryRef.current.get('battleDetail') || 0} isBackground />}
